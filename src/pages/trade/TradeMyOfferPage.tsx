...
const TradeMyOfferPage: React.FC = () => {
	...
	if (!adding && user.uid !== tradeOffer?.posterUid) return <Redirect to='/trade/my-offers' />
			...
			<IonHeader>
				<IonToolbar>
					<IonButtons slot='start'>
						<IonBackButton defaultHref='/trade/my-offers' />
					</IonButtons>
...
export default TradeMyOfferPage
