...
type RestaurantItemPageProps = {
	userFavoriteItems: RestaurantBagItemModel[]
}

const RestaurantItemPage: React.FC<RestaurantItemPageProps> = ({ userFavoriteItems }) => {
	const { restaurantPathParamB64, restaurantBagItemB64 } = useParams<{ restaurantPathParamB64: string; restaurantBagItemB64: string }>()
